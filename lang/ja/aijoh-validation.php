...
return [
    ...
    'encode_to' => ':Attributeは、:encodeで変換可能な文字列を指定してください。',
    'encode_to_eucjp' => ':Attributeは、EUC-JPで変換可能な文字列を指定してください。',
    'encode_to_ms932' => ':Attributeは、MS932で変換可能な文字列を指定してください。',
    'encode_byte_max' => ':Attributeは、:encode変換時に:maxバイト以内で入力してください。',
    'encode_byte_between' => ':Attributeは、:encode変換時に:minバイト以上:maxバイト以内で入力してください。',
];
